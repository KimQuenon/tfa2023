...
<body>
    ...
    <div class="slide">
        <div id="commodites">
            <div id="commodites_all">
                <div id="commodites_title">
                    <h1>COMMMODITÉS</h1>
            ...
            <div class="commodites_all">
                ...
                <div class="commodites_right" id="cr_1">
                    <div class="container">
                        ...
                        <p>Dégustez des spécialités de Belgique et de France grâce à nos foodtrucks partenaires. Accès illimité à toutes heures de la journée (ou de la nuit). Les festivaliers munis d'un pass "All Inclusive" se verront leur nourriture offerte !<br> <br> Envie d'en savoir davantage sur nos partenaires ? Visitez notre section dédiée à nos sponsors !</p>
                        <a href="valeurs.php#sponsors" class=btn>NOS SPONSORS ></a>
                    </div>
                </div>
            </div>
            <div class="commodites_all">
